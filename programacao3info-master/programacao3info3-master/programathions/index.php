...
<ul>
    ...
    <li><a href="produtos.php?categoria=1" id="esporte">Esportes</a></li>
	<li><a href="produtos.php?categoria=2" id="eletro">Eletronicos</a></li>
	<li><a href="produtos.php?categoria=3" id="roupa">Roupas</a></li>
